        ...
        <div class="row">
            <div class="col-xl-12">
                <div class="banner-content">
                    <h2 class="text-white">Galery Kegiatan</h2>
                    <div class="page-breadcrumb">
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb">
                                <li class="breadcrumb-item active" aria-current="page">Ikuti update  galery kegiatan kami</li>
                            </ol>
                        </nav>
                    </div>
                </div>
        ...
        <div class="row">
            <div class="col-xl-6 col-lg-7 col-md-9 mx-auto">
                <div class="section-title text-center mb-55">
                    <h2 class="wow fadeInUp" data-wow-delay=".4s">Galery Kegiatan Kami</h2>
        ...
        @foreach($data as $kegiatan)
            <div class="col-xl-4 col-lg-4 col-md-6">
                <div class="single-blog mb-40 wow fadeInUp card" data-wow-delay=".2s"
                    ...
                    <div class="blog-img">
                        <a href="{{url('kegiatan/'.$kegiatan->slug)}}"><img src="{{url('public/media/images/'.$kegiatan->thumnail)}}" width="100%" alt=""></a>
                        <span class="date-meta px-2">{{$kegiatan->tanggal}}</span>
                    </div>
                    <div class="blog-content px-2 py-2">
                        <h5><a href="{{url('kegiatan/'.$kegiatan->slug)}}">{{ Str::limit($kegiatan->judul, 55) }}</a></h5>
